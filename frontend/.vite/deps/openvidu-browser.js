    ...
    var OpenViduLogger = (
      ...
      function() {
        ...
        OpenViduLogger2.prototype.getConsoleWithJSNLog = function() {
          return /* @__PURE__ */ function(openViduLogger) {
            return {
              log: function() {
                var args = [];
    ...
    var WebRtcPeer = (
      ...
      function() {
        function WebRtcPeer2(configuration) {
          ...
          platform = Platform_1.PlatformUtils.getInstance();
          this.configuration = __assign(__assign({}, configuration), { iceServers: !!configuration.iceServers && configuration.iceServers.length > 0 ? configuration.iceServers : freeice(), rtcConfiguration: configuration.rtcConfiguration !== void 0 ? configuration.rtcConfiguration : {}, mediaStream: configuration.mediaStream !== void 0 ? configuration.mediaStream : null, mode: !!configuration.mode ? configuration.mode : "sendrecv", id: !!configuration.id ? configuration.id : this.generateUniqueId() });
          logger.debug("[WebRtcPeer] configuration:\n".concat(JSON.stringify(this.configuration, null, 2)));
          var rtcConfiguration = this.configuration.rtcConfiguration ? this.configuration.rtcConfiguration : { iceServers: this.configuration.iceServers };
              ...
              return __generator(this, function(_c) {
                switch (_c.label) {
                      ...
                      if (_this2.stream.isSendVideo()) {
                        _this2.getVideoDimensions().then(function(dimensions) {
                          ...
                          if (_this2.stream.isSendScreen()) {
                            if (_this2.stream.isSendAudio() && mediaStream2.getAudioTracks().length === 0) {
                              _this2.stream.audioActive = false;
                              _this2.stream.hasAudio = false;
                              _this2.stream.outboundStreamOpts.publisherProperties.publishAudio = false;
                              _this2.stream.outboundStreamOpts.publisherProperties.audioSource = false;
                            }
                  ...
                  case 2:
                    ...
                    if (!(!!myConstraints.videoTrack && !!myConstraints.audioTrack || !!myConstraints.audioTrack && ((_a = myConstraints.constraints) === null || _a === void 0 ? void 0 : _a.video) === false || !!myConstraints.videoTrack && ((_b = myConstraints.constraints) === null || _b === void 0 ? void 0 : _b.audio) === false)) return [3, 3];
    ...
    function JsonRpcClient(configuration) {
      ...
      function sendPing() {
        if (enabledPings) {
          ...
          pingNextNum++;
          self.send("ping", params, /* @__PURE__ */ function(pingNum) {
            ...
            return __generator(this, function(_c) {
              switch (_c.label) {
                ...
                case 3:
                  ...
                  if (!(options.videoSource === "screen" || options.videoSource === "window" || platform.isElectron() && options.videoSource.startsWith("screen:"))) return [3, 12];
