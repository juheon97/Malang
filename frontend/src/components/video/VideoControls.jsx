...
const VideoControls = ({ isMicOn, isCameraOn, toggleMic, toggleCamera, isVoiceTranslationOn = false, isSignLanguageOn = false, toggleVoiceTranslation, toggleSignLanguage }) => {
  return (
