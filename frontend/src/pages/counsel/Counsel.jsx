...
const Counsel = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
        ...
        <div className="max-w-7xl mx-auto p-6 mt-6 bg-white rounded-3xl shadow-2xl relative overflow-hidden">
            ...
            {counselors.map((counselor) => (
              ...
              >
                ...
                >
                  ...
                  {/* 프로필 이미지 */}
                  <div className="relative mx-auto w-20 h-20 mb-2 rounded-full shadow-lg overflow-hidden"
                    style={{
                      background: `#f9d3c0`,
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-3 leading-relaxed">저한테 상담받으세요~</p>
